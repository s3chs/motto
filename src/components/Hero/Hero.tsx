    ...
    return (
        <div className="hero-container" data-scroll-section>
            <div className="hero-content">
                <span className="bar-description" data-scroll data-scroll-speed="1"
                ...
                <div className="bar-infos">
                    <div className="bar-openings" data-scroll data-scroll-speed="1" data-scroll-position="top">
                        <span>33, rue piliers de tutelle</span>
                        <span>bordeaux</span>
                        <span className="opening-days">tuesday — saturday, 3pm till late</span>
                    </div>
